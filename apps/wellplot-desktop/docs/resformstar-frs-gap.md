...
| 高程剖面 (MSL) / 拉平剖面 | 🟡 | `datum/well_section_datum.py:19-79` md/tvdss/horizon；tvdss 为 -kb 近似（非真海拔） | 真 TVDSS datum（survey.py 已算 kb−TVD，tvdss 分支仍 -kb 近似，接 survey 即可）→ Desktop(datum) |
