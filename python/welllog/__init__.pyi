...
class WellLogView(QOpenGLWidget):
    ...
    def click_pick_info(self) -> dict[str, object] | None: ...
    ...
    def crosshair_state(self) -> dict[str, object] | None: ...
    def set_crosshair(
        self,
        document_id: str,
    ...
    def clear_crosshair(self, document_id: str) -> dict[str, object]: ...
    def set_depth_selection(
        self, document_id: str, top: float, bottom: float
    ) -> dict[str, object]: ...
    def set_viewport_depth_range(
        self, document_id: str, top: float, bottom: float
    ) -> dict[str, object]: ...
