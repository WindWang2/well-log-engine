...
class WellLogView(QOpenGLWidget):
    ...
    def apply_track_command(self, payload: dict[str, Any]) -> dict[str, object]: ...
    def hover_info(self) -> dict[str, object] | None: ...
    def selection_state(self) -> dict[str, object] | None: ...
    def set_row_selection(
        self, axis_id: str, first_row: int, last_row: int
    ) -> dict[str, object]: ...
    def presentation_state(self, document_id: str) -> dict[str, object] | None: ...
